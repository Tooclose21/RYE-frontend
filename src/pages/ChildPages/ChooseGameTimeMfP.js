...
function ChooseGameTimeMfP() {
    return (
        <div style={{ position: 'fixed', top: 0, left: 0, width: '100%', height: '100%', backgroundColor: '#B2F1FF' }}>
            ...
            <Link to={`/MimicFromPicture?quests=5`}><Button loc={{position: 'absolute', top: '35%', left: '40%',
                width: '25%', height: '8%', color: '#F8A365'}} color="#FEE8AA">5 quests</Button></Link>
            <Link to={`/MimicFromPicture?quests=10`}><Button loc={{position: 'absolute', top: '45%', left: '40%',
                width: '25%', height: '8%', color: '#F8A365'}} color="#FEE8AA">10 quests</Button></Link>
            <Link to={`/MimicFromPicture?quests=15`}><Button loc={{position: 'absolute', top: '55%', left: '40%',
                width: '25%', height: '8%', color: '#F8A365'}} color="#FEE8AA">15 quests</Button></Link>
            <Link to={`/MimicFromPicture?quests=${Infinity}`}><Button loc={{position: 'absolute', top: '65%', left: '40%',
